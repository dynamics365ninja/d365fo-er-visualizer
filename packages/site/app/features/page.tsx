...
export const metadata: Metadata = {
  title: 'Features',
  description:
    'Everything the D365FO ER Visualizer does: XML and live F&O ingestion, node-graph designers for data models, mappings and formats, where-used tracing, expression drill-down, Excel and PDF preview, label resolution, and an optional desktop shell.',
...
const blocks: FeatureBlock[] = [
  ...
  },
  {
    ...
    points: [
      ...
      'A progress panel shows every configuration as it is queued, downloaded, skipped, or fails',
    ],
  ...
  },
  {
    ...
    points: [
      'Tabbed designers with an explorer tree that can group everything by data model',
      'A workspace manager listing exactly what is loaded — add, close, or re-add a single configuration',
      'Recent files and sessions re-open from a local browser cache, with no second trip to the environment',
