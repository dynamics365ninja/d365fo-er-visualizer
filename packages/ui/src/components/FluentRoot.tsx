...
const lightOverrides: Partial<Theme> = {
  ...
  colorBrandBackground: '#2f6fb3',
  colorBrandBackgroundHover: '#3f7fc3',
  colorBrandBackgroundPressed: '#245f9b',
  colorBrandBackground2: 'rgba(47, 111, 179, 0.1)',
  colorBrandForeground1: '#2f6fb3',
  colorBrandForeground2: '#3f7fc3',
  colorBrandStroke1: '#2f6fb3',
  colorBrandStroke2: 'rgba(47, 111, 179, 0.35)',
  colorCompoundBrandBackground: '#2f6fb3',
  colorCompoundBrandBackgroundHover: '#3f7fc3',
  colorCompoundBrandStroke: '#2f6fb3',
  fontFamilyBase: '"Segoe UI", "Segoe UI Variable", sans-serif',
  fontFamilyMonospace: '"Cascadia Code", Consolas, monospace',
  borderRadiusSmall: '4px',
  borderRadiusMedium: '6px',
