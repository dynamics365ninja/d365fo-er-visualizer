...
const cs: Translations = {
  ...
  fnoDraftOnlyHint: 'Konfigurace nemá žádnou dokončenou verzi. F&O vydává ke stažení jen dokončenou (effective) verzi — dokud ji nedokončíš v F&O, vrátí prázdno.',
...
const en: Translations = {
  ...
  fnoDraftOnly: 'Draft',
  fnoDraftOnlyHint: 'This configuration has no completed version. F&O only serves the completed (effective) version for download, so it answers empty until the version is completed in F&O.',
