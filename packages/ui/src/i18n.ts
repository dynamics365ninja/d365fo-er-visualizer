...
const cs: Translations = {
  ...
  landingSub: 'Přehledné pracovní místo pro konfigurace elektronického výkaznictví: modely, mapování i formáty na jednom místě. Načti soubory z disku nebo přímo z D365 F&O serveru, proklikej se od formulí ke zdrojovým tabulkám, dohledej where-used vazby a přeskakuj mezi souvisejícími soubory.',
  ...
  landingStep1Desc: 'Přetáhni XML soubory z disku, nebo se připoj přímo k D365 F&O serveru a stáhni konfigurace online. Nejlepší je načíst všechny tři typy (Model + Mapování + Formát), protože teprve pak funguje plný drill-down napříč konfigurací.',
...
const en: Translations = {
  ...
  landingBadge: 'D365 Finance & Operations · Electronic Reporting',
  landingTitle: 'D365FO ER Visualizer',
  landingSub: 'A clear workspace for Electronic Reporting configurations: data models, mappings and formats in one place. Load files from disk or directly from a D365 F&O server, trace formulas back to source tables, find where-used references, and jump between related files.',
  ...
  landingStep1Desc: 'Drag-and-drop XML files from disk, or connect directly to a D365 F&O server to download configurations online. For full cross-configuration drill-down, load all three types (Model + Mapping + Format).',
